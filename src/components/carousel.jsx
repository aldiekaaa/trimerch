...
const Carousel = () => {
    return (
        <div id="animation-carousel" class="relative w-full z-0 mt-20 duration-1000" data-carousel="static">
            <div class="relative w-full h-[17rem] md:h-[30rem] rounded-lg overflow-hidden">
                <div class="hidden duration-1000 ease-in-out" data-carousel-item="active">
                    ...
                    <div className="absolute flex flex-col items-center text-center gap-3 top-1/2 lg:w-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <span className="text-white text-xs md:text-base">Casual Never Looked This Good</span>
                        <span className="text-white text-xl md:text-4xl font-semibold">Perfect Fit, Perfect Vibe, Perfect You.</span>
                    </div>
                </div>
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    ...
                    <div className="absolute flex flex-col items-center text-center gap-3 top-1/2 lg:w-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <span className="text-white text-2xl md:text-4xl font-semibold">Shades On, Game On</span>
                ...
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    ...
                    <div className="absolute flex flex-col items-start gap-3 px-2 md:px-0 top-1/2 -translate-y-1/2 md:bottom-24 md:w-1/3 md:left-20">
                        <span className="text-white md:text-start">Accessorize with Confidence</span>
                        <span className="text-white text-xl md:text-4xl font-semibold md:text-start">Find the perfect piece for any occasion.</span>
